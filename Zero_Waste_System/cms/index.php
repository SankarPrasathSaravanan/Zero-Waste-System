...
<head>
   ...
   <title>Zero waste collection system</title>
...
<body>
            ...
            <div id="main_slider" class="carousel slide" data-ride="carousel">
               <div class="carousel-inner">
                  <div class="carousel-item active">
                     <h1 class="banner_taital">Today, recycle for a better tomorrow </h1>
                  ...
                  <div class="carousel-item">
                     <h1 class="banner_taital">Think before your trash</h1>
                     <div class="read_bt"></div>
                     <div class="number_main">
   ...
   <div class="copyright_section">
      <div class="container">
         <p class="copyright_text">Zero waste collection system</p>
      </div>
   </div>
